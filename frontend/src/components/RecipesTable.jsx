        ...
        <div className="recipes-container flex justify-center p-5">
            ...
            {!recipe || !isOpen ?
                (<table className="table-auto ">
                                ...
                                <tr key={index}>
                                    ...
                                    <td className="border px-4 py-2">
                                        <div className="flex flex-row gap-1">
                                            <button className="bg-green-500 text-white  px-6 py-1">
                                                <FontAwesomeIcon icon={faEye} className="px-2" onClick={() => viewProduct(recipe)} />
                                            </button>
                    ...
                    </table>) : <ShowRecipe recipe={recipe} setIsOpen={setIsOpen} />
            }
            </div>
        </div>
  );
